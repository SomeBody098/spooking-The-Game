...
public class Wall implements Obstacles {
    ...
    public Wall(String name, float x, float y, float wight, float height, World world) {
    ...
    private Body createBody(String name, float x, float y, float wight, float height, World world){
